...
const translations = {
    "zh_CN": {
        "mpvpaper": {
            ...
            "Prevent mpv-mpris, uosc, and other local MPV scripts from loading in wallpaper processes. Recommended.": "防止 mpv-mpris、uosc 等本机 MPV 脚本被视频壁纸进程加载。建议保持开启。",
            "Custom MPV Options": "自定义 MPV 参数",
            "These options are appended after the plugin-generated MPV options.": "参数将追加到插件生成的 MPV 参数之后。",
